...
namespace TowerDefense
{
    class EnemySlow : Enemy
    {
        ...
        //Constructer
        public EnemySlow(string name, float eSlow, int eRange, float hp, float speed, int armor, int worth, Effect effect, string imagePath, PointF position, PointF endPosition, bool isClickable): base(name,hp,speed,armor,worth,effect,imagePath,position,endPosition,isClickable)
        {
            this.eSlow = eSlow;
            this.eRange = eRange;
        }
